...
class AmapController with WidgetsBindingObserver, IMapController {
  ...
  Future<void> showMyLocation(MyLocationOption option) async {
    ...
    await platform(
      android: (pool) async {
        final map = await androidController!.getMap();
        final locationStyle = await com_amap_api_maps_model_MyLocationStyle
            .create__();
        ...
        if (option.show) {
          ...
          await locationStyle.strokeColor(
            Int32List.fromList([option.strokeColor.toARGB32()])[0],
          );
          // 填充颜色
          await locationStyle.radiusFillColor(
            Int32List.fromList([option.fillColor.toARGB32()])[0],
          );
          // 边框宽度
      ...
      ios: (pool) async {
        ...
        if (option.show) {
          if (option.interval != Duration.zero) {
            ...
            _locateSubscription = Stream.periodic(option.interval, (v) => v)
                .listen((_) {
  ...
  Future<IMarker> addMarker(MarkerOption option) {
    ...
    return platform(
      android: (pool) async {
        ...
        // marker配置
        final markerOption = await com_amap_api_maps_model_MarkerOptions
            .create__();
      ...
      ios: (pool) async {
        ...
        // widget as marker
          ...
          List<Uint8List> iconData = (await state!.widgetToImageData([
            option.widget!,
          ]))!;
  ...
  Future<List<IMarker>> addMarkers(List<MarkerOption> options) async {
    ...
    final infoWindowEnabledBatch = options
        .map((it) => it.infoWindowEnabled)
        .toList();
  ...
  Future<void> clearMarkers(List<IMarker> markers) async {
    await platform(
      android: (pool) async {
        final markerBatch = markers
            .cast<Marker>()
            .map((it) => it.androidModel)
            .toList();
  ...
  Future<IPolyline> addPolyline(PolylineOption option) async {
    ...
    final longitudeBatch = option.coordinateList
        .map((e) => e.longitude)
        .toList();
    ...
    return platform(
      android: (pool) async {
        ...
        // 构造折线参数
        final polylineOptions = await com_amap_api_maps_model_PolylineOptions
            .create__();
      ...
      ios: (pool) async {
        ...
        // 颜色
        await polyline.addJsonableProperty__(2, option.strokeColor.toARGB32());
        // 设置图片
        if (textureData != null) {
  ...
  Future<IPolygon> addPolygon(PolygonOption option) {
    ...
    return platform(
      android: (pool) async {
        ...
        // 构造参数
        final polygonOptions = await com_amap_api_maps_model_PolygonOptions
            .create__();
      ...
      ios: (pool) async {
        ...
        await polygon.addJsonableProperty__(2, option.strokeColor.toARGB32());
        await polygon.addJsonableProperty__(3, option.fillColor.toARGB32());
        if (option.zIndex != null) {
          // TODO ios端未实现
  ...
  Future<ICircle> addCircle(CircleOption option) {
    return platform(
      android: (pool) async {
        ...
        // 构造参数
        final circleOptions = await com_amap_api_maps_model_CircleOptions
            .create__();
      ...
      ios: (pool) async {
        ...
        await circle.addJsonableProperty__(2, option.strokeColor.toARGB32());
        await circle.addJsonableProperty__(3, option.fillColor.toARGB32());
  ...
  Future<void> setMarkerClickedListener(OnMarkerClicked onMarkerClicked) async {
    await platform(
      android: (pool) async {
        ...
        final listener = await com_amap_api_maps_AMap_OnMarkerClickListener
            .anonymous__();
  ...
  Future<void> setMarkerDragListener({
    ...
    await platform(
      android: (pool) async {
        ...
        final listener = await com_amap_api_maps_AMap_OnMarkerDragListener
            .anonymous__();
  ...
  Future<void> setMapClickedListener(OnMapClicked onMapClick) async {
    await platform(
      android: (pool) async {
        ...
        final listener = await com_amap_api_maps_AMap_OnMapClickListener
            .anonymous__();
  ...
  Future<void> setMapLongPressedListener(OnMapClicked onMapLongPress) async {
    await platform(
      android: (pool) async {
        ...
        final listener = await com_amap_api_maps_AMap_OnMapLongClickListener
            .anonymous__();
  ...
  Future<void> setMapMoveListener({
    ...
    await platform(
      android: (pool) async {
        ...
        final listener = await com_amap_api_maps_AMap_OnCameraChangeListener
            .anonymous__();
  ...
  Future<Uint8List> screenShot() async {
    return platform(
      android: (pool) async {
        ...
        final listener = await com_amap_api_maps_AMap_OnMapScreenShotListener
            .anonymous__();
  ...
  Future<IUrlTileOverlay> addUrlTileOverlay(UrlTileOption option) async {
    ...
    return platform(
      android: (pool) async {
        ...
        final options = await com_amap_api_maps_model_TileOverlayOptions
            .create__();
        ...
        if (option.gradient != null) {
          await builder.gradient(
            await com_amap_api_maps_model_GradientX.create(
              Int32List.fromList(
                option.gradient!.colors.map((e) => e.toARGB32()).toList(),
              ),
  ...
  Future<void> setCustomMapStyle({
    ...
    await platform(
      android: (pool) async {
        ...
        // 构造选项
        final option = await com_amap_api_maps_model_CustomMapStyleOptions
            .create__();
  ...
  Future<IMultiPointOverlay> addMultiPointOverlay(
    ...
    final latitudeBatch = option.pointList
        .map((it) => it.coordinate.latitude)
        .toList();
    final longitudeBatch = option.pointList
        .map((it) => it.coordinate.longitude)
        .toList();
